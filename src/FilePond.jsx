...
function Pond() {
  ...
  // const fromFlutter = () => {
  //   console.log("mansur", window.okay)
  // }
  // useEffect(() => {
  //   window.fromFlutter = function () {};
  //   // console.log("mansur", window.);
  // }, []);
  window.fromFlutter = (data) => {
    console.log("This is the testing", data);
  };

  return (
    <div className="App">
      <div>
        {/* <img src={oneFile} alt="testing" /> */}
        {/* <img
      ...
      <MetaTags>
        <title>mansurUploadMetaTags</title>
        <meta name="description" content="this is mansur upload" />
        <meta property="og:title" content="MansurUpload" />
